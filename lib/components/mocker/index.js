...
var getFakerMethod = function (path) { return utils_1.objectPath(faker_1.default, path); };
var createEnum = function (enumElements) { return utils_1.randomElement(enumElements); };
var createDate = function () {
    return faker_1.default.date.between(new Date('2015-01-01'), new Date('2021-01-01'));
};
var createBoolean = function () { return faker_1.default.random.boolean(); };
...
var createString = function (format) {
    if (format === void 0) { format = 'random.words'; }
...
var createFakeData = function (_a) {
    ...
    return function (_a) {
        var _b = _a.type, type = _b === void 0 ? 'string' : _b, _c = _a.format, format = _c === void 0 ? 'random.words' : _c, _d = _a.minimum, minimum = _d === void 0 ? 0 : _d, _e = _a.maximum, maximum = _e === void 0 ? 99999999 : _e, _f = _a.minLength, minLength = _f === void 0 ? 0 : _f, _g = _a.maxLength, maxLength = _g === void 0 ? 500 : _g, rest = __rest(_a, ["type", "format", "minimum", "maximum", "minLength", "maxLength"]);
        if (rest.enum) {
        ...
        if (/^image\[\d+x\d+\]/.test(format)) {
            var _h = extractImageSize(format), width = _h[0], height = _h[1];
...
var generateArrayItems = function (_a) {
    var _b = _a.minItems, minItems = _b === void 0 ? 0 : _b, _c = _a.maxItems, maxItems = _c === void 0 ? 15 : _c, items = _a.items;
...
var createMockGenerator = function (_a) {
    var imageProvider = _a.imageProvider;
    return function (model) {
        return parser_1.processor(createFakeData({ imageProvider: imageProvider }), { items: generateArrayItems }, parser_1.getResponseModel(model));
    };
};
